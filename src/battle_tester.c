...
// gcc battle_tester.c -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer -o battle
...
int main(int argc, char *argv[])
{
	...
	state.currentBattle.battleType = 0;
	
	// register events used for starting battle
	registerEvent(LOGIC_HANDLER,initBattle,state.listeners);
